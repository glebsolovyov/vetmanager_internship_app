...
class _AppRestClient implements AppRestClient {
  ...
  Future<List<AdmissionDto>> fetchAdmissions(
    ...
    final _options = _setStreamType<List<AdmissionDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data!
          .map((dynamic i) => AdmissionDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  @override
  Future<AdmissionDto> fetchAdmission(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdmissionDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AdmissionDto _value;
    try {
      _value = AdmissionDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
